...
var Landing = React.createClass({
  render: function() {
    return (
        ...
        <SectionRotatingBg>
          ...
          <div className="col-xs-6 col-xs-push-3 dashboard-content-landing">
            ...
            <div className="col-xs-12 text-center page-scroll">
              <a href="#about"><span className="glyphicon glyphicon-chevron-down dashboard-glyphicons"></span></a>
            </div>
          </div>
        </SectionRotatingBg>
        <section id="about">
      ...
      //               <button type="submit" className="btn btn-default dashboard-button-medium-black dashboard-large">Sign Up</button>
      //             </div>
      //           </form>
      //         </div>
